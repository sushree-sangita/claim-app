...
/**
 * @ngdoc object
 * @name lbServices.Claim
 * @header lbServices.Claim
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Claim` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Claim#create
         * @methodOf lbServices.Claim
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Claim` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/Claims",
        ...
        /**
         * @ngdoc method
         * @name lbServices.Claim#createMany
         * @methodOf lbServices.Claim
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Claim#patchOrCreate
         * @methodOf lbServices.Claim
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Claim#replaceOrCreate
         * @methodOf lbServices.Claim
         *
         * @description
         *
         ...
         */
        "replaceOrCreate": {
          url: urlBase + "/Claims/replaceOrCreate",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Claim#exists
         * @methodOf lbServices.Claim
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/Claims/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Claim#findById
         * @methodOf lbServices.Claim
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/Claims/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Claim#replaceById
         * @methodOf lbServices.Claim
         *
         * @description
         *
         ...
         */
        "replaceById": {
          url: urlBase + "/Claims/:id/replace",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Claim#find
         * @methodOf lbServices.Claim
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/Claims/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Claim#updateAll
         * @methodOf lbServices.Claim
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/Claims/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Claim#deleteById
         * @methodOf lbServices.Claim
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/Claims/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Claim#prototype$patchAttributes
         * @methodOf lbServices.Claim
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Claim#createChangeStream
         * @methodOf lbServices.Claim
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/Claims/change-stream",
          method: "POST"
        },
      }
    );
        ...
        /**
         * @ngdoc method
         * @name lbServices.Claim#updateOrCreate
         * @methodOf lbServices.Claim
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Claim#destroyById
         * @methodOf lbServices.Claim
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Claim#removeById
         * @methodOf lbServices.Claim
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Claim#updateAttributes
         * @methodOf lbServices.Claim
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Claim#modelName
    * @propertyOf lbServices.Claim
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Claim`.
    */
